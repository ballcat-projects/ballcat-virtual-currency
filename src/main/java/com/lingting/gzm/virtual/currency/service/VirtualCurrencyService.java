...
public interface VirtualCurrencyService {
	 ...
	 * @return 交易信息
	 */
	Optional<VirtualCurrencyTransaction> getTransactionByHash(String hash) throws IOException, VirtualCurrencyException;
	 ...
	 */
	Integer getDecimalsByContract(Contract contract) throws IOException;
	 ...
	 */
	BigDecimal getBalanceByAddressAndContract(String address, Contract contract) throws IOException;
	 ...
	 */
	default BigDecimal getNumberByAddressAndContract(String address, Contract contract) throws IOException {
	 ...
	 */
	default BigDecimal getNumberByBalanceAndContract(BigDecimal balance, Contract contract) throws IOException {
	 ...
	 * @author lingting 2020-12-11 17:20
	 */
	BigDecimal getNumberByBalanceAndContract(BigDecimal balance, Contract contract, MathContext mathContext) throws IOException;
	 ...
	 */
	boolean transfer(VirtualCurrencyAccount from, String to, Contract contract, BigDecimal value) throws IOException;
