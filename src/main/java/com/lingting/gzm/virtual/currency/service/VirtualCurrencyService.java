...
public interface VirtualCurrencyService {
	 ...
	 */
	Integer getDecimalsByContract(Contract contract);
	 ...
	 */
	BigDecimal getBalanceByAddressAndContract(String address, Contract contract);
	 ...
	 */
	default BigDecimal getNumberByAddressAndContract(String address, Contract contract) {
	 ...
	 */
	default BigDecimal getNumberByBalanceAndContract(BigDecimal balance, Contract contract) {
